...
<body>
    <div class="container">
        ...
        <div class="loginBox">
            ...
            <div class="inputBox">
                <input type="text" placeholder="Username" class="inputStyle"> <br>
                <input type="password" placeholder="Password" class="inputStyle"> <br>
                <input type="checkbox" name="" class="check"> <span>Remember me</span>
                <a href="#">Forget Password?</a> <br>
                <input type="button" value="Login" class="loginBtn"> <br> <br> <br>
